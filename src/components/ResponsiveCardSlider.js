...
const items = [
  { img: "/images/servicePage/nzxtgen-ev-car-charger-installation.webp", title: 'EV Car Chargers', description: 'Quick & Fast Charging Options Available', link: '/services/ev-charger-installation' },
  ...
  { img: "/images/servicePage/nzxtgen-wall-chasing-concealed-cabling.webp", title: 'Wall Chasing', description: 'New Builds & Renovations', link: '/builders-contracting/new-builds-renovations#wall-chasing' },
  { img: "/images/servicePage/nzxtgen-aircon-cabling-connection.webp", title: 'A/C Cabling & Connections', description: 'Run & Connect Power To A/C Units', link: '/builders-contracting/new-builds-renovations#aircon' },
  { img: "/images/servicePage/nzxtgen-bathroom-ixl-exhaust-fan.webp", title: 'Bathroom IXL Units', description: 'Now With New Cool Fan, Heat Fan Options & Smart Control', link: '/builders-contracting/new-builds-renovations#bathroom' },
  ...
  { img: "/images/servicePage/nzxtgen-gate-motor-connection.webp", title: 'Gate Connections', description: 'Run & Connect Power To Gate Motors', link: '/builders-contracting/new-builds-renovations#gate-garage' },
  ...
  { img: "/images/servicePage/nzxtgen-kitchen-appliance-installation.webp", title: 'Kitchen Appliances', description: 'In Built & Free Standing Ovens, Grills, Range Hoods Etc.', link: '/builders-contracting/new-builds-renovations#kitchen' },
  { img: "/images/servicePage/nzxtgen-electrical-renovation-rewiring.webp", title: 'Renovations', description: 'Repair, Rewire, Renew', link: '/builders-contracting/new-builds-renovations' },
  ...
  { img: "/images/servicePage/nzxtgen-granny-flat-electrical-wiring.webp", title: 'Grannyflat', description: 'Granny Flat Mains Wiring & Internal Wiring', link: '/builders-contracting/new-builds-renovations' },
  ...
  { img: "/images/servicePage/nzxtgen-water-heater-electrical-connection.webp", title: 'Water Heater Connections', description: 'Water Heater Cabling & Connections', link: '/builders-contracting/new-builds-renovations#water-heating' },
  { img: "/images/servicePage/nzxtgen-garage-electrical-installation.webp", title: 'Garage', description: 'Garage Cabling & Connections', link: '/builders-contracting/new-builds-renovations#gate-garage' },
  ...
  { img: "/images/servicePage/nzxtgen-new-build-electrical-wiring.webp", title: 'New Builds', description: 'Wire From Scratch With Smart Controls', link: '/builders-contracting/new-builds-renovations' },
  ...
  { img: "/images/servicePage/nzxtgen-strata-electrical-maintenance.webp", title: 'Strata', description: 'Replacements, Maintenance, Fault Finding, Repairs', link: '/builders-contracting/commercial-industrial-electrical' },
  ...
  { img: "/images/servicePage/nzxtgen-commercial-electrical-small-large-scale.webp", title: 'Commercial', description: 'Small & Large Scale', link: '/builders-contracting/commercial-industrial-electrical' },
  ...
  { img: "/images/servicePage/nzxtgen-floor-heating-bathroom-tile-heating.webp", title: 'Floor Heating', description: 'Bathroom Heating & Tile Heating', link: '/builders-contracting/new-builds-renovations#bathroom' },
  { img: "/images/servicePage/nzxtgen-industrial-electrical-small-large-scale.webp", title: 'Industrial', description: 'Small & Large Scale', link: '/builders-contracting/commercial-industrial-electrical' },
  ...
  { img: "/images/servicePage/nzxtgen-residential-new-builds-reno-electrical.webp", title: 'Residential', description: 'New Builds, Reno & Electrical', link: '/builders-contracting/residential-electrical' },
